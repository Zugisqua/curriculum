...
<\body>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|<around*|(|\<mathd\>\<circ\>i<rsub|X>+i<rsub|X>\<circ\>\<mathd\>|)>\<alpha\><around*|(|Y|)>>|<cell|=>|<cell|\<mathd\>\<circ\>i<rsub|X>\<alpha\><around*|(|Y|)>+i<rsub|X>\<circ\>\<mathd\>\<alpha\><around*|(|Y|)>>>|<row|<cell|>|<cell|=>|<cell|\<mathd\><around*|(|\<alpha\><around*|(|X,Y|)>|)>+\<mathd\>\<alpha\><around*|(|X,Y|)>>>|<row|<cell|>|<cell|=>|<cell|>>>>
  </eqnarray*>
