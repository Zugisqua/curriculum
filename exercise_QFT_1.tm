...
<\body>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|H>|<cell|=>|<cell|<big|int>\<mathd\><rsup|3>x<around*|{|\<pi\><rprime|\<asterisk\>>\<pi\>+\<nabla\>\<phi\><rprime|\<asterisk\>>\<cdot\>\<nabla\>\<phi\>+m<rsup|2>\<phi\><rprime|\<asterisk\>>\<phi\>|}>>>|<row|<cell|>|<cell|=>|<cell|<big|int>\<mathd\><rsup|3>x<big|int><frac|i\<mathd\><rsup|3>k|2<around*|(|2\<pi\>|)><rsup|3>><big|int><frac|-i\<mathd\><rsup|3>k<rprime|'>|2<around*|(|2\<pi\>|)><rsup|3>><around*|{|\<nospace\><around*|(|a<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>-b<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>|)><around*|(|a<around*|(|\<nospace\><embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>-b<rprime|\<dag\>><around*|(|\<nospace\>\<nospace\><embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>|)><new-line><frac|<embold|k>|w<rsub|<embold|k>>><around*|(|a<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>-b<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>|)><frac|<embold|k<rprime|'>>|w<rsub|<embold|k<rprime|'>>>><around*|(|a<around*|(|<embold|k>|)>e<rsup|-\<nospace\>i\<nospace\>k\<nospace\>x>-b<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>|)>+<frac|1|w<rsub|<embold|k>>w<rsub|<embold|k<rprime|'>>>><around*|(|a<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>+b<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>|)><new-line><around*|(|a<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>+b<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>|)>|}>>>|<row|<cell|>|<cell|=>|<cell|<big|int><frac|\<mathd\><rsup|3>x\<mathd\><rsup|3>k\<mathd\><rsup|3>k<rprime|'>|4<around*|(|2\<pi\>|)><rsup|6>><around*|{|<around*|(|<frac|<embold|kk<rprime|'>>|w<rsub|<embold|k>>w<rsub|<embold|k<rprime|'>>>>+1|)><around*|(|a<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>-b<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>|)><around*|(|a<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>-b<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>|)><new-line>+<frac|1|w<rsub|<embold|k>>w<rsub|<embold|k<rprime|'>>>><around*|(|a<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>-b<around*|(|<embold|k>|)>e<rsup|-i\<nospace\>k\<nospace\>x>|)><around*|(|a<around*|(|<embold|k>|)>e<rsup|-\<nospace\>i\<nospace\>k\<nospace\>x>-b<rprime|\<dag\>><around*|(|<embold|k>|)>e<rsup|i\<nospace\>k\<nospace\>x>|)>|}>>>>>
  </eqnarray*>
...
<\references>
  <\collection>
    <associate|auto-1|<tuple|1|?|exercise_QFT_1.tm~>>
    <associate|auto-2|<tuple|1|?|exercise_QFT_1.tm~>>
    <associate|auto-3|<tuple|2|?|exercise_QFT_1.tm~>>
  </collection>
</references>
